...
def get_jobs_df(url):
    ...
    try:
        # sometimes these columns wouldnt exist in certain results, therefore resulting in a keyerror. Implementing a for loop to check if exists (df.columns), then remove
